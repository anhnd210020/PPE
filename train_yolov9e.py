...
Usage:
    ...
    python train_yolov9e.py --mode full --device 0,1       # both GPUs
    python train_yolov9e.py --mode finetune --weights runs/yolov9e_full/weights/best.pt
    python train_yolov9e.py --mode full --resume            # resume interrupted training
"""
...
def main():
    ...
    print(f"\n{'='*55}")
    print(f"  YOLOv9e — {args.mode.upper()}")
    print(f"{'='*55}")
